...
class RsvpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post rsvps_url, params: { rsvp: { attendees: @rsvp.attendees, name: @rsvp.name, song: @rsvp.song } }
    end
  ...
  test "should update rsvp" do
    patch rsvp_url(@rsvp), params: { rsvp: { attendees: @rsvp.attendees, name: @rsvp.name, song: @rsvp.song } }
